...
export class RegisterPage {
  ...
  async fillSignForm(usersData: FormValues){
    await this.page.fill('input[data-qa="signup-name"]', usersData.name);
    await this.page.fill('input[data-qa="signup-email"]', usersData.email);
  }

  async fillAccountInfoForm(usersData: FormValues) {
    // Checking Mr. or Mrs.
    if (usersData.title === "Mrs.") {
